const strickButton = document.getElementById("button");
const resetButton = document.getElementById("button1");
const $team1Score = document.getElementById("team1Score");
const $team1Wickets = document.getElementById("team1Wickets");
const $team2Score = document.getElementById("team2Score");
const $team2Wickets = document.getElementById("team2Wickets");
...
strickButton.onclick = () => {
    ...
    if(turn===1){
        ...
        if(team1BallsFaced===6 || team2BallsFaced===6) turn=2;
    }
